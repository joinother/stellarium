...
SOURCES=(
  ...
  "harmonyos/ets-source/pages/PrivacyConsent.ets:build/libstellarium-harmonyos/entry/src/main/ets/pages/PrivacyConsent.ets"
  ...
  "harmonyos/resources/base/element/color.json:build/libstellarium-harmonyos/entry/src/main/resources/base/element/color.json"
