...
in Greek, published in the Second Century and remained a major
astronomical work in the traditions that transmitted it for the following 1500 years. It was originally written
with the title <i>Mathematike Syntaxis</i>, in Ancient Greek.
The name <i>Almagest</i>, meaning &ldquo;The Largest [Book]&rdquo;, was
developed from Arabian translations. To create this sky culture the compiling team used
...
are common today) and the team made use of computer readable tables prepared
by Ernie Wright.</p>
